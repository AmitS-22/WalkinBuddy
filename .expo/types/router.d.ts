...
declare module "expo-router" {
  ...
  // prettier-ignore
  type StaticRoutes = `/` | `/(tabs)/_layout` | `/_layout` | `/(tabs)/alerts` | `/alerts` | `/(tabs)/explore` | `/explore` | `/(tabs)/` | `/(tabs)` | `/(tabs)/profile` | `/profile` | `/(tabs)/scan` | `/scan` | `/(tabs)/sos` | `/sos` | `/family` | `/loading` | `/login` | `/modal` | `/services` | `/signup`;
  // prettier-ignore
